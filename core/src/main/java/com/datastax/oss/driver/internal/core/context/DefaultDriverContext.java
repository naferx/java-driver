...
public class DefaultDriverContext implements InternalDriverContext {
  ...
  private final AuthProvider autProviderFromBuilder;
  ...
  public DefaultDriverContext(
    ...
    this.autProviderFromBuilder = programmaticArguments.getAuthProvider();

    this.authProviderRef =
        new LazyReference<>(
            "authProvider", () -> buildAuthProvider(autProviderFromBuilder), cycleDetector);
